...
components = [Label('Check a choisir'),
              ...
              Label('Version Revit'),
              ComboBox('combobox1', {2015,2016,2017,2018,2019}),
              Label('Nom maquette exacte'),
              TextBox('textbox1', Text="EXEMPLE_MAQUETTE.rvt"),
              Label('Poids maximum maquette'),
              ComboBox('combobox2', {150,200,250,300,350,400,450}),
              Label('choisir maquette QNP'),
              select_file('Revit Model (*.rvt)|*.rvt'),
              Label('choisir visa Excel'),
              select_file('Excel Model (*.xls)|*.xls'),
              Separator(), 
              Button('OK GO')]
