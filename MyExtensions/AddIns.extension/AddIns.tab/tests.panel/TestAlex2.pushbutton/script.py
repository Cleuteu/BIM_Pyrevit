...
# # Get SharedParameters in the doc and their categories
...
#       try:
#         pCatFrench = Revit.Elements.Category.ById(cat.Id.IntegerValue).Name
#         if pCatFrench == "Murs":
#           pCatEnglish = "Wall"
#         elif pCatFrench == "Sols":
#           pCatEnglish = "Slab"
#         elif pCatFrench == "Pi\xe8ces":
#           pCatEnglish = "Room"
#         elif pCatFrench == "Portes":
#           pCatEnglish = "Doors"
#         elif pCatFrench == "Poteaux porteurs":
#           pCatEnglish = "Column"
#         # TODO : Traduire toutes les cat vers IFC
#         thesecats.append(pCatEnglish)
#       except:
#           thesecats.append(None)
#   cats[iterator.Key.Name] = thesecats
# print cats




#Sauvegarde du Pyrevit Economiste Excel
import clr
import System
import math
